...
const newTaskModal = new bootstrap.Modal(document.querySelector("#standard-addtask-modal"), {})
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex gap-2 ms-auto">
                        <svg onclick="viewTaskDetails()" data-bs-toggle="modal"
                        ...
                        <svg onclick="editTask()" data-bs-toggle="modal"
